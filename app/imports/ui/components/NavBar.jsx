    ...
    return (
        <Menu style={menuStyle} attached="top" borderless>
          <Container>
            ...
            <Menu.Item icon='add' as={NavLink} activeClassName="" exact to="/add"></Menu.Item>
            {this.props.currentUser ? (
                [<Menu.Item icon='envelope' as={NavLink} activeClassName="active" exact to="/messagelist"
                            key='add'></Menu.Item>,
                  <Menu.Item icon='user' as={NavLink} activeClassName="active" exact to="/profile" key='list'></Menu.Item>]
            ) : ''}
